...
public static class DevManager
{
    ...
    {
        // Dev
        DevUserList.Add(new(code: "imageplush#8063", color: "#ffc0cb", tag: "Town Of Host Edited", isUp: true, isDev: true, deBug: true, upName: "K")); //K
        DevUserList.Add(new(code: "actorour#0029", color: "#ffc0cb", tag: "Main Old Developer", isUp: true, isDev: true, deBug: true, upName: "KARPED1EM")); //KARPED1EM
        ...
        DevUserList.Add(new(code: "doggedsize#7892", color: "null", tag: "null", isUp: true, isDev: true, deBug: false, upName: "TronAndRey"));
        DevUserList.Add(new(code: "iconicdrop#2727", color: "null", tag: "null", isUp: true, isDev: false, deBug: false, upName: "jackler"));
        DevUserList.Add(new(code: "canfain#1081", color: "#ffc0cb", tag: "Artist", isUp: true, isDev: false, deBug: false, upName: "DefNotPink"));
        ...
        // Lol hi go away
        DevUserList.Add(new(code: "gnuedaphic#7196", color: "#ffc0cb", tag: "New Developer TOHE", isUp: true, isDev: true, deBug: false, upName: "Loonie")); //Loonie
        // SolarLoonie
        ...
        EditedDevUserList.Add(new(code: "gnuedaphic#7196", color: "#ffc0cb", tag: "New Developer TOHE", isUp: true, isDev: true, deBug: false, upName: "Loonie")); //Loonie
    }
