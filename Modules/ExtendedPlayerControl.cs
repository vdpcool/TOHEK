...
static class ExtendedPlayerControl
{
    ...
    public static bool CanUseKillButton(this PlayerControl pc)
    {
        ...
        return pc.GetCustomRole() switch
        {
            ...
            CustomRoles.SillySheriff => SillySheriff.CanUseKillButton(pc.PlayerId),
            CustomRoles.PlatonicLover => PlatonicLover.CanUseKillButton(pc.PlayerId),
            ...
            CustomRoles.Janitor => false,
            CustomRoles.Bomber => (Options.BomberCanUseKillButton.GetBool()),
    ...
    public static bool CanUseImpostorVentButton(this PlayerControl pc)
    {
        ...
        //    CustomRoles.SwordsMan or
            ...
            CustomRoles.Camouflager => Camouflager.CanVent.GetBool(),
       ...
       //     CustomRoles.NWitch => NWitch.CanVent.GetBool(),
            ...
            CustomRoles.Deputy => Deputy.CanVent.GetBool(),
    ...
    public static void ResetKillCooldown(this PlayerControl player)
    {
        ...
        switch (player.GetCustomRole())
        {
            ...
            case CustomRoles.FreeMan:
                Main.AllPlayerSpeed[player.PlayerId] = 3f;
                break;
          ...
          //case CustomRoles.Sidekick:
            ...
            case CustomRoles.SillySheriff:
                SillySheriff.SetKillCooldown(player.PlayerId); //シェリフはシェリフのキルクールに。
                break;
            case CustomRoles.PlatonicLover:
                PlatonicLover.SetKillCooldown(player.PlayerId);
                break;
