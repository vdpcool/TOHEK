...
public static class AntiBlackout
{
    ...
    ///</summary>
    public static bool IsRequired => Options.NoGameEnd.GetBool() || Jackal.IsEnable || Pelican.IsEnable || Gamer.IsEnable || BloodKnight.IsEnable || Succubus.IsEnable || Poisoner.IsEnable || Infectious.IsEnable || Juggernaut.IsEnable || Ritualist.IsEnable() || Virus.IsEnable || Wraith.IsEnable || HexMaster.IsEnable || Traitor.IsEnable || Pickpocket.IsEnable || NSerialKiller.IsEnable || NWitch.IsEnable  || Maverick.IsEnable || Jinx.IsEnable || Medusa.IsEnable || Spiritcaller.IsEnable || Pirate.IsEnable || CovenLeader.IsEnable || Banshee.IsEnable || Necromancer.IsEnable || RuthlessRomantic.IsEnable || CustomRoles.Sidekick.RoleExist();
    ///<summary>
