...
public static class Medic
{
    ...
    public static void SetupCustomOption()
    {
        ...
        ShieldDeactivatesWhenMedicDies = BooleanOptionItem.Create(Id + 24, "MedicShieldDeactivatesWhenMedicDies", true, TabGroup.CrewmateRoles, false)
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.Medic]);
        ShieldDeactivationIsVisible = StringOptionItem.Create(Id + 25, "MedicShieldDeactivationIsVisible", ShieldDeactivationIsVisibleOption, 0, TabGroup.CrewmateRoles, false)
    ...
    {
        MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.SetMedicProtectLimit, SendOption.Reliable, -1);
    ...
    public static void OnCheckMurderForMedic(PlayerControl killer, PlayerControl target)
    {
