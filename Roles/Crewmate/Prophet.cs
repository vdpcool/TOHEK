...
public static class Prophet
{
    ...
    public static void SetupCustomOption()
    {
        ...
        SkillCooldown = FloatOptionItem.Create(Id + 10, "ProphetSkillCooldown", new(2.5f, 180f, 2.5f), 20f, TabGroup.CrewmateRoles, false).SetParent(Options.CustomRoleSpawnChances[CustomRoles.Prophet])
            .SetValueFormat(OptionFormat.Seconds);
        SkillLimitOpt = IntegerOptionItem.Create(Id + 12, "ProphetSkillLimit", new(1, 5, 1), 3, TabGroup.CrewmateRoles, false).SetParent(Options.CustomRoleSpawnChances[CustomRoles.Prophet])
