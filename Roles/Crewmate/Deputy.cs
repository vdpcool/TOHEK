...
public static class Deputy
{
    ...
    public static void SetupCustomOption()
    {
        ...
        CanVent = BooleanOptionItem.Create(Id + 15, "CanVent", false, TabGroup.CrewmateRoles, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.Deputy]);
    }
    ...
    {
        bool Deputy_canUse = CanVent.GetBool();
        DestroyableSingleton<HudManager>.Instance.ImpostorVentButton.ToggleVisible(Deputy_canUse && !player.Data.IsDead);
        player.Data.Role.CanVent = Deputy_canUse;
    }
