...
public static class Snitch
{
    ...
    public static OptionItem SnitchHasPortableButton;
    public static OptionItem SnitchNumOfUseButton;
    public static OptionItem SnitchRevealWhenDoneTasks;
    ...
    public static void SetupCustomOption()
    {
        ...
        SnitchHasPortableButton = BooleanOptionItem.Create(Id + 15, "SnitchHasPortableButton", false, TabGroup.CrewmateRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Snitch]);
        SnitchNumOfUseButton = IntegerOptionItem.Create(Id + 16, "SnitchNumOfUseButton", new(1, 3, 1), 1, TabGroup.CrewmateRoles, false).SetParent(SnitchHasPortableButton);
        SnitchRevealWhenDoneTasks = BooleanOptionItem.Create(Id + 17, "SnitchRevealWhenDoneTasks", false, TabGroup.CrewmateRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Snitch]);
    ...
    private static bool IsSnitchTarget(PlayerControl target) => IsEnable && (target.Is(CustomRoleTypes.Impostor) && !target.Is(CustomRoles.Trickster) && !target.Is(CustomRoles.PlatonicLover)|| (target.IsSnitchTarget() && CanFindNeutralKiller) || (target.Is(CustomRoles.Madmate) && CanFindMadmate) || (target.Is(CustomRoles.Rascal) && CanFindMadmate));
