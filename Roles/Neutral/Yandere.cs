...
public static class Yandere
{
    ...
    public static void SetupCustomOption()
    {
        ...
        SkillCooldown = FloatOptionItem.Create(Id + 16, "KillCooldown", new(2.5f, 900f, 2.5f), 20f, TabGroup.NeutralRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Yandere])
