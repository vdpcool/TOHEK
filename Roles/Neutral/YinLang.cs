...
{
    private static readonly int Id = 51933;
    ...
    {
        Options.SetupSingleRoleOptions(51933, TabGroup.NeutralRoles, CustomRoles.YinLang, 1, zeroOne: false);
        ...
        YLHasImpostorVision = BooleanOptionItem.Create(Id + 13, "YLHasImpostorVision", true, TabGroup.NeutralRoles, false).SetParent(Options.CustomRoleSpawnChances[CustomRoles.YinLang]);
