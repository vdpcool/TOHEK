            ...
            if (player.IsAlive())
            {
                ...
                switch (player.GetCustomRole())
                {
                    ...
                    case CustomRoles.Morphling:
                        __instance.AbilityButton.OverrideText(GetString("MorphlingButtonText"));
                        break;
                    ...
                    case CustomRoles.Medic:
                        __instance.KillButton.OverrideText(GetString("MedicButtonText"));
                        break;
                    ...
                    case CustomRoles.Janitor:
                        __instance.ReportButton.OverrideText(GetString("JanitorReportButtonText"));
                        break;
                    ...
                    case CustomRoles.Jester:
                        __instance.AbilityButton.buttonLabelText.text = GetString("JesterVentButtonText");
                        break;
                    ...
                    case CustomRoles.Snitch:
                        __instance.AbilityButton.buttonLabelText.text = GetString("SnitchVentButtonText");
                        break;
                    case CustomRoles.Copycat:
                        __instance.KillButton.buttonLabelText.text = GetString("CopycatKillButtonText");
                        break;
                    ...
                    case CustomRoles.TimeStops:
                        __instance.AbilityButton.buttonLabelText.text = GetString("TimeStopsVentButtonText");
                        break;
                    ...
                    case CustomRoles.Rudepeople:
                        __instance.AbilityButton.buttonLabelText.text = GetString("RudepeopleVentButtonText");
                        break;
                    case CustomRoles.GlennQuagmire:
                        __instance.AbilityButton.buttonLabelText.text = GetString("GlennQuagmireVentButtonText");
                        break;
...
class VentButtonDoClickPatch
{
    public static bool Prefix(VentButton __instance)
    {
        var pc = PlayerControl.LocalPlayer;
        {
            ...
            if (pc.GetCustomRole() is CustomRoles.Swooper or CustomRoles.Arsonist or CustomRoles.Revolutionist or CustomRoles.Veteran or CustomRoles.Paranoia or CustomRoles.Mayor or CustomRoles.Grenadier or CustomRoles.DovesOfNeace or CustomRoles.Rudepeople or CustomRoles.TimeStops or CustomRoles.TimeMaster)
