...
public static class CredentialsPatch
{
    ...
    public static class LogoPatch
    {
        ...
        public static string ContributorsData = "";
        ...
        public static void InitCredentialsData()
        {
            ...
            DevsData += $"<color={Main.ModColor}>♡Loonie</color> - <size=75%>{GetString("MainDev")}</size>";
            DevsData += $"<color={Main.ModColor}>♡K</color> - <size=75%>{GetString("MainDev")}</size>";
            DevsData += $"\n<color={Main.ModColor}>DefNotPink</color> - <size=75%>{GetString("Art")}</size>";
        ...
        static void ViewBoosterPatch(MainMenuManager __instance)
        {
            ...
            boostertitletext.localPosition = new Vector3(-2.4f, 0f, -2f);
            ...
            boostertext.localPosition = new Vector3(-2.4f, -0.38f, -2f);
            boostertext.localScale = new Vector3(0.5f, 0.5f, 1f);

            var contributorstitletext = Object.Instantiate(devtitletext, obj.transform);
            contributorstitletext.GetComponent<TextMeshPro>().text = GetString("Contributor");
            contributorstitletext.GetComponent<TextMeshPro>().alignment = TextAlignmentOptions.Center;
            contributorstitletext.localPosition = new Vector3(0f, 0f, -2f);
            contributorstitletext.localScale = new Vector3(0.8f, 0.8f, 1f);

            var contributorstext = Object.Instantiate(devtext, obj.transform);
            contributorstext.GetComponent<TextMeshPro>().text = ContributorsData;
            contributorstext.GetComponent<TextMeshPro>().alignment = TextAlignmentOptions.Capline;
            contributorstext.localPosition = new Vector3(0f, -0.38f, -2f);
            contributorstext.localScale = new Vector3(0.5f, 0.5f, 1f);
