...
internal class ChangeRoleSettings
{
    public static void Postfix(AmongUsClient __instance)
    {
        ...
        try
        {
            ...
            Main.SnitchUsedButtonCount = new();
...
internal class SelectRolesPatch
{
    ...
    public static void Postfix()
    {
                ...
                switch (pc.GetCustomRole())
                {
                 ...
                 //   case CustomRoles.Sidekick:
                    ...
                    case CustomRoles.Snitch:
                        Main.SnitchUsedButtonCount[pc.PlayerId] = 0;
                        break;
        ...
        EndOfSelectRolePatch:
            ...
            Main.ResetCamPlayerList.AddRange(Main.AllPlayerControls.Where(p => p.GetCustomRole() is CustomRoles.Arsonist or CustomRoles.PlatonicLover or CustomRoles.NWitch or CustomRoles.Revolutionist or CustomRoles.Farseer or CustomRoles.KB_Normal or CustomRoles.Shaman).Select(p => p.PlayerId));
